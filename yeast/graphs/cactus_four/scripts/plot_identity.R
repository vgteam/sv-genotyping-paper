...
construct_new %>%
  ...
  labs(color="Strain", size="Percent identity threshold", x="Mapped read fraction on construct graph", y="Mapped read fraction on cactus graph", alpha="Included in graph", pch="Clade") +
